  ...
  <div>
    ...
    <header>
      <nav class="navbar">
        <div class="navbar-container">
          <!-- Brand Logo and Name -->
          <a href="/" class="brand">
            <img :src="logo_2" alt="Brand Logo" class="brand-logo" />

          </a>

          <!-- Navbar Links -->
          <ul class="nav-links" v-if='drawer'>
            <li><a href="/wallets">Home</a></li>
            <li><a href="/wallets">Staking</a></li>
            <li><a href="/wallets">Contact</a></li>
          ...
          <div class="mobile-menu-icon" id="mobile-menu-icon" @click="drawer = !drawer">
    ...
    <div class="hero">
      <div class="showcase-content">
        <h1>Stake Your $BEN</h1>
        <p>Unstake Anytime. Anywhere.</p>
        <a href="/wallets" class="btn btn-xl">
          Migrate
    ...
    <div class="stake-ben">
      <p>Stake Your $BEN</p>
      <div class="stakes-count">
        <span>Total Stake</span>
        <p>112133394877 $BEN</p>
        <div class="days-tab">
          <div class="day">
            <span>30</span>
            <span>days</span>
      ...
      <div class="your-stake">
        <p>Your Stakes</p>
      </div>

      <div class="refresh-but">
        <button to="/wallets">Refresh</button>
      </div>
      <div class="form-table">
      <v-container>
      <v-simple-table style="background-color: transparent;color:white;"  >
        <thead>
          <tr>
            <th class="text-left">#</th>
            <th class="text-left">Staked Amount</th>
            <th class="text-left">Withdrawal Time</th>
            <th class="text-left">Unstake</th>
          </tr>
        </thead>
        <tbody class="t-body">
...
.showcase {
  ...
  height: 100vh;
  position: relative;
  background: url("https://github.com/sjvarnum/acme-media-showcase/blob/master/img/showcase.jpg?raw=true") no-repeat center center/cover;
}
...
.btn {
  ...
  cursor: pointer;
  outline: none;
  box-shadow: -1px -1px 223px -5px rgba(211,166,216,0.75);
-webkit-box-shadow: -1px -1px 223px -5px rgba(211,166,216,0.75);
-moz-box-shadow: -1px -1px 223px -5px rgba(211,166,216,0.75);
  border-radius: 2px;
  /*   margin-top: 3rem; */
}
...
.state{
  border: 1px solid #b8add2!important;
  border-radius:20px;
  width: 25%;
...
.form-txt{
  ...
  align-items: center;
  gap:10px;
  background-color: rgba(54, 78, 79, 0.4);
  color:white;
  padding: 5px;
  border-radius:10px;
  input{
...
.form-table{
 ...
 border-radius:  10px;
 box-shadow: -1px -1px 13px -1px rgba(234,234,234,0.75);
-webkit-box-shadow: -1px -1px 13px -1px rgba(234,234,234,0.75);
-moz-box-shadow: -1px -1px 13px -1px rgba(234,234,234,0.75);
margin-top: 20px;
